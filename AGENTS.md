# mc-commands
  ...
  - В блоке «Что нового» показывать только функциональность, доступную обычным non-admin пользователям сайта.
  - При значимых изменениях функциональности, заметных обычным non-admin пользователям публичных генераторов или публичных страниц, обязательно добавлять запись в блок «Что нового» на лендинге.
  - Для изменений админки, внутренних инструментов, служебных сценариев и функций, доступных только администраторам, запись в «Что нового» не добавлять, даже если эти изменения технически находятся на публичной странице.
